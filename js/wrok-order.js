...
// separacion 5,5
    ...
    writeTextInDoc(doc,"Orden N°","<Orden n°>",fourthColumn,19,27);
    writeTextInDoc(doc,"Fecha de Ingreso","<Fecha de Ingreso>",fifthColumn,19,27);
    writeTextInDoc(doc,"Nombre / Empresa","<Nombre / Empresa>",firstColumn,32,118);
    writeTextInDoc(doc,"Cantidad","<Cantidad>",fifthColumn,32,67);
    writeTextInDoc(doc,"Trabajo","<Trabajo>",firstColumn,43,118);
    writeTextInDoc(doc,"Páginas","<Páginas>",fifthColumn,43,27);
    writeTextInDoc(doc,"Vías","<Vías>",sixthColumn,43,27);
    writeTextInDoc(doc,"Armado x Pliego","<Armado>",firstColumn,54,26.5);
    writeTextInDoc(doc,"Faces","<Faces>",secondColumn ,54, 26.5);
    writeTextInDoc(doc,"Tamaño Abierto","<Abierto>",thirdColumn, 54, 26.5);
    writeTextInDoc(doc,"Tamaño Cerrado","<Vías>",fourthColumn,54,26.5);
    writeTextInDoc(doc,"Numerado","<Numerado>",fifthColumn, 54, 26.5);
